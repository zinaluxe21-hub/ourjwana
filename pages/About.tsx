      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center mb-32">
          <div className="rounded-[3rem] overflow-hidden shadow-2xl">
            <img src="https://images.unsplash.com/photo-1590073844006-33379778ae09?auto=format&fit=crop&q=80&w=1200" alt="Marrakech Crafts" />
          </div>
            ...
            <div className="space-y-8">
              {[
                ...
                <div key={i} className="flex gap-6">
                  <div className="flex-shrink-0 w-12 h-12 bg-primary/10 rounded-2xl flex items-center justify-center text-primary">{item.icon}</div>
                  <div>
