      ...
      <div className="container mx-auto px-6">
        <div className="max-w-7xl mx-auto">
           <div className="grid lg:grid-cols-2 gap-20">
             ...
             <div className="bg-secondary p-10 md:p-16 rounded-[3rem] shadow-inner relative overflow-hidden">
               <div className="absolute top-0 right-0 w-64 h-64 bg-primary/5 rounded-full blur-3xl -mr-32 -mt-32" />
               <form className="relative z-10 space-y-6">
                 <div>
                   <label className="text-[10px] font-bold text-gray-400 uppercase mb-2 block px-2">Nom Complet</label>
                   <input type="text" className="w-full bg-white border-none rounded-2xl p-5 shadow-sm" placeholder="Votre nom" />
                 </div>
                 <div>
                   <label className="text-[10px] font-bold text-gray-400 uppercase mb-2 block px-2">Sujet</label>
                   <input type="text" className="w-full bg-white border-none rounded-2xl p-5 shadow-sm" placeholder="Location long terme, événement..." />
                 </div>
                 <div>
                   <label className="text-[10px] font-bold text-gray-400 uppercase mb-2 block px-2">Message</label>
                   <textarea className="w-full bg-white border-none rounded-2xl p-5 shadow-sm h-40" placeholder="Comment pouvons-nous vous aider ?"></textarea>
                 </div>
                 <button className="w-full bg-accent text-white py-6 rounded-2xl font-bold shadow-xl hover:bg-primary transition-all">Envoyer le message</button>
               </form>
             </div>
           </div>
        </div>
